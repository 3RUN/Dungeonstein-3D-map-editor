#ifndef _ASSETS_PARAMS_H_
#define _ASSETS_PARAMS_H_
...
// PROPS
// * "event_type" is holding activation type (0 - interaction (default), 1 - trigger zone, 2 - switch, 3 - none (for simple door))
...
// PLAYER START EVENT
// * "event_id" is holding id of starting weapon (0 - knife (default), 1 - pistol, 2 - shotgun, 3 - chaingun, 4 - rocketlauncher)
